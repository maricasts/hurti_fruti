...
if (!isset($_SESSION['email'])) {
    ...
    echo "Sessão iniciada. E-mail: " . htmlspecialchars($_SESSION['email']);
}
...
<head>
    ...
    <title>Hurti Fruti - Frutas para Provar</title>
...
<body class="flex flex-col items-center">
    ...
    <div class="menu-list" id="menu-list">
        <div>
            <h3 class="text-xl font-bold mb-4">Frutas que você quer provar:</h3>
    ...
    <main class="flex flex-col items-center p-6 md:p-12 w-full">
        <h2 class="text-3xl font-bold mb-6">Escolha as frutas que você quer provar!</h2>
        <div class="carousel">
            <!-- Frutas -->
